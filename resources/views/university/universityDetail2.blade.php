                            ...
                            <div class="rc-pop-detail">
                                ...
                                <div>
                                    <p>It was a nice experience by itself to visit such a great university. The
                                        architectural design is great and the university of well managed. It sits on the
                                        lap of mountains and has a natural environment. Small portion of this university
                                        is covered with dense trees and one can spend his or her quality time either
                                        studying or doing creative works. It was a good experience being there</p>
                                </div>
                            </div>
            ...
            <div class="row tu-nav">
                <div class="col-12">
                    <ul>
                        ...
                        <a href="#const_campus">
                            <li class="ud-nav" onclick="myFunction(event)"><span>Campuses</span></li>
                        </a>
                        <a href="#const_campus">
                            <li class="ud-nav" onclick="myFunction(event)"><span>Colleges</span></li>
                        </a>
                        <a href="#gallery">
        ...
        <div class="col-12 px-0">
            <div class="row mx-md-0 mx-3">
                <div class="col-lg-9 col-md-12 col-12">
                    ...
                    <div class="row tu-au-wrapper">
                        ...
                        <div class="col-12 mt-3">
                            <p>Tribhuvan University (TU; Nepali: िभुवन िविवालय) is a public university for higher
                    ...
                    <div class="row tu-cc-wrapper">
                        ...
                        <div class="col-12 mb-3">
                            <button class="btn" style="float:right;border:2px solid #707070;">View More
                                Colleges</button>
                        </div>
                    </div>
                    ...
                    <div class="row" style="background-color:#ffffff;box-shadow: 0px 0px 4px rgba(0,0,0,.5); border-radius: 10px; margin-bottom:5vh;">
                        <div class="col-12 my-5">
                            <span style="font-size:1.5rem;font-weight:600;">Qna section</span>
                        </div>
                ...
                <div class="col-lg-3 col-md-12 col-12">
                    ...
                    <div class="row ml-md-2 mx-0 mt-3 for-siroe">
                        <div class="col-12 apply-section2">
                            <span style="font-size:1rem;">DOWNLOAD BROCHURE</span>
                            <span style="float:right;"><img src="{{asset('./images/college_logo1.png')}}"></span>
                        </div>
                    </div>
                    <div class="row ml-md-2 mx-0 mt-3 for-siroe" style=  box-shadow:0px 0px 4px rgba(0,0,0,.5);">
